---
title: "Utiliser GitHub - Wild Code School"
source: "https://odyssey.wildcodeschool.com/quests/3042/pages/16088"
author:
published:
created: 2026-03-23
...
Github est un site communautaire permettant d'héberger du code et bien plus.
...
- [👉 Création d'un compte et Dashboard](https://odyssey.wildcodeschool.com/quests/3042/pages/16088#-cr%C3%A9ation-dun-compte-et-dashboard)
	- [🔏 Créer un compte](https://odyssey.wildcodeschool.com/quests/3042/pages/16088#-cr%C3%A9er-un-compte)
		- [🔬 C'est parti!](https://odyssey.wildcodeschool.com/quests/3042/pages/16088#-cest-parti-)
		- [🔎 Vue d'ensemble du Dashboard:](https://odyssey.wildcodeschool.com/quests/3042/pages/16088#-vue-densemble-du-dashboard-)
		- [🔬 Exercice](https://odyssey.wildcodeschool.com/quests/3042/pages/16088#-exercice)
- [👉 Création d'un dépôt](https://odyssey.wildcodeschool.com/quests/3042/pages/16088#-cr%C3%A9ation-dun-d%C3%A9p%C3%B4t)
	- [🗄️ Les éléments essentiels d'un dépôt](https://odyssey.wildcodeschool.com/quests/3042/pages/16088#%EF%B8%8F-les-%C3%A9l%C3%A9ments-essentiels-dun-d%C3%A9p%C3%B4t)
		- [🔎 Vue d'ensemble d'un dépôt:](https://odyssey.wildcodeschool.com/quests/3042/pages/16088#-vue-densemble-dun-d%C3%A9p%C3%B4t-)
		- [🔬 Exercice](https://odyssey.wildcodeschool.com/quests/3042/pages/16088#-exercice-1)
- [☝️ Résumé](https://odyssey.wildcodeschool.com/quests/3042/pages/16088#%EF%B8%8F-r%C3%A9sum%C3%A9)
- [📝 Quiz](https://odyssey.wildcodeschool.com/quests/3042/pages/16088#-quiz)
- [💪 Challenge](https://odyssey.wildcodeschool.com/quests/3042/pages/16088#-challenge)
- [🧐 Critères d'acceptation](https://odyssey.wildcodeschool.com/quests/3042/pages/16088#-crit%C3%A8res-dacceptation)
...
```shell
Voir la solutionHome : l'icône de la maison te ramène à la page d'accueil de GitHub.
...
```shell
Le lien vers la base de connaissance GitHubhttps://github.com/git-guides
```
...
```shell
# 1  - Qu'est-ce que GitHub ?Une plateforme pour héberger des projets.Un éditeur de texte.Valider# 2 README.mdLICENSEValider# 3 Une modification enregistrée dans l'historique.Un commentaire sur une issueValiderTon score :0 / 3
```
...
Quête terminée le **jeudi 16 octobre 2025**