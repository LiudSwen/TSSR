---
title: "Git/GitHub 1 : Découvrir GitHub - Wild Code School"
source: "https://odyssey.wildcodeschool.com/quests/2133/pages/11825"
author:
published:
created: 2026-03-23
...
```shell
# 1  -  Qu'est-ce qu'un repo GitHubLa contribution d'un développeur à un projetUn raccourci pour repositoryLe nom d'un projet géré par gitValider# 2 L'enregistrement de modifications dans le projetUne demande d'ajout de fonctionnalité dans un projetUn projet hébergé sur GiHubValider# 3 Récupérer n'importe quelle version précédente d'un fichier d'un dépôtVérifier que le code est fonctionnelCopier un dépôt pour travailler en parallèleValider# 4 VraiFauxValiderTon score :0 / 4
```
...
[https://github.com/LiudSwen/helloWorld/tree/main](https://github.com/LiudSwen/helloWorld/tree/main)